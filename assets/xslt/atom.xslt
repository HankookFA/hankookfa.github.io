...
<xsl:template match="/atom:feed">
	...
	<meta property="og:url" content="https://hankookfa.github.io/assets/xslt/atom.xslt">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li ><a id="/" href="https://hankookfa.github.io/en/">Home</a></li>
              <li class="divider"></li>
              ...
              <li ><a id="/package-sale/" href="https://hankookfa.github.io/en/package-sale/">Package Sale</a></li>
              <li class="divider"></li>
              ...
              <li ><a id="/items-wanted/" href="https://hankookfa.github.io/en/items-wanted/">Items Wanted</a></li>
              <li class="divider"></li>
  ...
  if (window.sessionStorage) {
    switch ( sessionStorage.getItem('lang')) {
      case 'cn':  document.getElementById("/smt-equipment/").innerHTML = '库存设备';
                  ...
                  document.getElementById("/items-wanted/").innerHTML = '매입설비(중)';
                  document.getElementById("/language/").innerHTML = '언어(중)';
                  document.getElementById("/contact/").innerHTML = '연락처(중)';
                  // location.href='/cn/';
        break;
